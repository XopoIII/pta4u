...
function mainFunc() {
  return (
    <div className="px-5 flex flex-col gap-[9px] xl:gap-[112px] xl:px-0 items-center justify-center md:flex-row-reverse relative xl:max-w-[1280px] pt-5">
      ...
      <div className="flex justify-center items-center xl:items-start flex-col gap-3 xl:gap-0 md:max-w-[400px] xl:max-w-[510px] xl:pt-8">
        ...
        <p className="leading-[18.2px] text-[14px] xl:max-w-[532px] xl:leading-[31px] xl:pt-[29px] font-normal text-center xl:text-[18px] xl:text-start">
...
export default function ServicesTowPage() {
  return (
    <div className={'h-full mx-auto flex flex-col items-center'}>
      {mainFunc()}
      <div className="bg-[#F2F2F2] flex flex-col justify-center items-center w-full px-5 py-8 mt-9 lg:py-14">
        <div>
          <h2 className="text-dark font-semibold md:text-2xl md:leading-[28.8px] text-[18px] leading-[21.8px] text-center lg:text-2xl lg:text-start lg:w-fit">
